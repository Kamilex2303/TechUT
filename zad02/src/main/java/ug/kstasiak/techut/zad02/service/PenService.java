...
public class PenService {
    ...
    public PenService() throws SQLException {
        ...
        addPenStmt = connection.prepareStatement("INSERT INTO Bicycle (producer, size, dateOfProduction, isBlack) VALUES (?,?,?,?)");
        getAllPensStmt = connection.prepareStatement("SELECT * FROM Bicycle");
        getPenByIdStmt = connection.prepareStatement("SELECT * FROM Bicycle WHERE ID=?");
        deleteAllPensStmt = connection.prepareStatement("DELETE FROM Bicycle");
        deletePenByIdStmt = connection.prepareStatement("DELETE FROM Bicycle WHERE ID=?");
    }
